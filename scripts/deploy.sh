...
nohup java --spring.config.location=$YML_NAME --spring.profiles.active=default -jar $DEPLOY_JAR >> /home/ec2-user/deploy.log 2>/home/ec2-user/action/deploy_err.log &