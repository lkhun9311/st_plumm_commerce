...
nohup java --spring.config.location=/home/ec2-user/action/src/main/resources/application.yml -jar $DEPLOY_JAR >> /home/ec2-user/deploy.log 2>/home/ec2-user/action/deploy_err.log &