...
nohup java -jar $DEPLOY_JAR --spring.config.location=/home/ec2-user/action/src/main/resources/application.yml >> /home/ec2-user/deploy.log 2>/home/ec2-user/action/deploy_err.log &